...
const Ourteam = () => {
  ...
  useEffect(() => {
    ...
    return () => tiltRef2.current?.vanillaTilt?.destroy();
  }, []);
    ...
    <section id="our_team">
      <div className="bg-cover bg-center bg-[url('https://i.ibb.co/gzJKtCJ/Background2.png')] pt-16 px-2 sm:px-10 font-montserrat text-[#FFFFFF]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-12 py-12">
          <div>
            <div data-tilt className="scrollanimation animate-appear rounded-2xl" ref={tiltRef1}>
              <img src={Manjunath} alt="" className="w-[27rem]"/>
            </div>
          ...
          <div>
            <div data-tilt className="scrollanimation animate-appear rounded-2xl" ref={tiltRef2}>
              <img src={Prashanthi} alt="" className="w-[27rem]"/>
            </div>
            <div className=" flex flex-col gap-5 mt-5">
          ...
          <div>
            <div data-tilt className="scrollanimation animate-appear rounded-2xl" ref={tiltRef}>
              <img src={Raghunath} alt="" className="w-[27rem]"/>
            </div>
            <div className=" flex flex-col gap-5 mt-5">
