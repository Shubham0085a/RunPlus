...
import PublishImg from "../src/assets/Publish.png";
import RespondImg from "../src/assets/Respond.png";
import AutomateImg from "../src/assets/Automate.png";
import MonitorImg from "../src/assets/Monitor.png";
import AnalyzeImg from "../src/assets/Analyze.png";
import CreativeContentImg from "../src/assets/Creative Content.png";
import Marquee from "react-fast-marquee";
import Button from "./components/button";
import Ourteam from "./components/ourteam";
import Curve from "./components/template";
        ...
        <div className="my-10 mx-10 sm:mx-20 font-montserrat flex flex-col lg:flex-row justify-center gap-20 lg:gap-5">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <div
              ...
              ref={tiltRef1}
            >
              <img src={mission1} alt="" className="h-80 sm:h-[25rem] w-auto" />
            </div>
            <div
              data-tilt
              className=" hover:shadow-2xl hover:shadow-[#25CBFF] rounded-3xl scrollanimation animate-appear"
              ref={tiltRef}
            >
              <img src={mission2} alt="" className="h-80 sm:h-[25rem] w-auto" />
            </div>
          </div>
        </div>
      </section>
